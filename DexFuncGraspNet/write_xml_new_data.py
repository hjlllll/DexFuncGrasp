...
def write_xml(obj_name, r, t, a, r_o, path, mode='train', rs=(21, 'real')):
    ...
    if mode=='new':
        name_text=dom.createTextNode('/home/lm/Documents/ddg_data/grasp_dataset/good_shapes/{}.obj.smoothed.xml'.format(str(obj_name)))
