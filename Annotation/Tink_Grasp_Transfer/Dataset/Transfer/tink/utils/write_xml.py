...
def robot_selection(dom, a, rs):
    if rs[0] == 21:
        ...
        elif rs[1] == 'directly22angles':
            name_text_rd = dom.createTextNode(
                '{} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {}'.format(
                    str(a[0]), str(a[1]), str(a[2]), str(a[3]), str(a[4]),
                    str(a[5]), str(a[6]), str(a[7]), str(a[8]),
                    str(a[9]), str(a[10]), str(a[11]), str(a[12]),
                    str(a[13]), str(a[14]), str(a[15]), str(a[16]),
                    str(a[17]), str(a[18]), str(a[19]), str(a[20]), str(a[21])))
...
def write_xml(obj_name, r, r_o, t, a, path, mode='train', rs=(21, 'real')):
...
def write_xml_new_data(category, obj_name, r, r_o, t, a, path, mode='train', rs=(21, 'real')): #save 22 angles
    dom=minidom.Document()
    world=dom.createElement('world')
    dom.appendChild(world)
    #  graspableBody
    ...
    graspableBody.appendChild(filename)
    if mode=='new':
        name_text=dom.createTextNode('/hjl_data/{}/{}.xml'.format(str(category),str(obj_name)))
    else:
        name_text=dom.createTextNode('/hjl_data/{}/{}.xml'.format(str(category), str(obj_name)))
    filename.appendChild(name_text)
